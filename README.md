...
* link to two different Google font in your index.html file. *Its okay to do this all at one time.*
* follow the instructions in the [google-fonts-links.md](google-fonts-links.md) file when linking
